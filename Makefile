...
pkgdatadir = $(datadir)/apertium-kgp-por
pkgincludedir = $(includedir)/apertium-kgp-por
pkglibdir = $(libdir)/apertium-kgp-por
pkglibexecdir = $(libexecdir)/apertium-kgp-por
...
am__installdirs = "$(DESTDIR)$(apertium_kgp_pordir)"
DATA = $(apertium_kgp_por_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} /home/drosset1/ling073/ling073-kgp-por/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/usr/include/apertium-3.5 -I/usr/lib/x86_64-linux-gnu/apertium-3.5/include -I/usr/include/lttoolbox-3.5 -I/usr/lib/x86_64-linux-gnu/lttoolbox-3.5/include -I/usr/include/libxml2
APERTIUM_KGP_CFLAGS = 
APERTIUM_KGP_LIBS = 
...
APERTIUM_POR_LIBS = 
AP_LIB1 = ../ling073-kgp
AP_LIB2 = ../apertium-por
AP_SRC1 = ../ling073-kgp
AP_SRC2 = ../apertium-por
AP_SUBDIRS =  ../ling073-kgp ../apertium-por
AUTOCONF = ${SHELL} /home/drosset1/ling073/ling073-kgp-por/missing autoconf
AUTOHEADER = ${SHELL} /home/drosset1/ling073/ling073-kgp-por/missing autoheader
AUTOMAKE = ${SHELL} /home/drosset1/ling073/ling073-kgp-por/missing automake-1.15
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CGPROC = /usr/bin/cg-proc
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ kgp-Portuguese\" -DPACKAGE_TARNAME=\"apertium-kgp-por\" -DPACKAGE_VERSION=\"0.2.0\" -DPACKAGE_STRING=\"Apertium\ kgp-Portuguese\ 0.2.0\" -DPACKAGE_BUGREPORT=\"drosset1@cs.swarthmore.edu\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-kgp-por\" -DPACKAGE=\"apertium-kgp-por\" -DVERSION=\"0.2.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/drosset1/ling073/ling073-kgp-por/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-kgp-por
PACKAGE_BUGREPORT = drosset1@cs.swarthmore.edu
PACKAGE_NAME = Apertium kgp-Portuguese
PACKAGE_STRING = Apertium kgp-Portuguese 0.2.0
PACKAGE_TARNAME = apertium-kgp-por
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-kgp-por
...
VERSION = 0.1.0
ZCAT = /bin/zcat
abs_builddir = /home/drosset1/ling073/ling073-kgp-por
abs_srcdir = /home/drosset1/ling073/ling073-kgp-por
abs_top_builddir = /home/drosset1/ling073/ling073-kgp-por
abs_top_srcdir = /home/drosset1/ling073/ling073-kgp-por
am__leading_dot = .
...
install_sh = ${SHELL} /home/drosset1/ling073/ling073-kgp-por/install-sh
...
###############################################################################
###############################################################################
apertium_kgp_pordir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_kgp_por_DATA = \
	$(TARGETS_COMMON)				\
	$(BASENAME).$(PREFIX1).t1x			\
	$(BASENAME).$(PREFIX1).t2x			\
	$(BASENAME).$(PREFIX1).t3x			\
...
$(am__aclocal_m4_deps):
install-apertium_kgp_porDATA: $(apertium_kgp_por_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_kgp_por_DATA)'; test -n "$(apertium_kgp_pordir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_kgp_pordir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_kgp_pordir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_kgp_pordir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_kgp_pordir)" || exit $$?; \
	done

uninstall-apertium_kgp_porDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_kgp_por_DATA)'; test -n "$(apertium_kgp_pordir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_kgp_pordir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_kgp_pordir)"; do \
...
install-data-am: install-apertium_kgp_porDATA install-data-local
...
uninstall-am: uninstall-apertium_kgp_porDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_kgp_porDATA install-data \
...
test: all
	echo "house" | apertium -d . kgp-por | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	echo "house" | apertium -d . por-kgp | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	@rm .test-ref .test-mt
